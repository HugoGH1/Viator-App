                ...
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-light-beige">
                            Únete y descubre qué hay en tu ciudad.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <label htmlFor="name" className="text-sm font-medium text-light-beige">
                                Nombre de Usuario
                            </label>
                            <div className="relative">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-light-beige" />
                                <Input
                                    id="name"
                                    type="text"
                        ...
                        <div className="space-y-2">
                            <label htmlFor="confirmPassword" className="text-sm font-medium text-light-beige">
                            ...
                            {confirmPassword.length > 0 && (
                                <div className="flex items-center gap-2 mt-1">
                                    {password === confirmPassword ? (
                                        <>
                                            <Check className="h-4 w-4 text-action-green" />
                                            <span className="text-xs text-action-green">Las contrasenas coinciden</span>
                                        </>
                                    ) : (
                                        <span className="text-xs text-red-400">Las contrasenas no coinciden</span>
                                    )}
                                </div>
                            )}
                        </div>
